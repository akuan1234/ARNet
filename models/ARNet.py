...
class ARNet(nn.Module):
    def __init__(self, channel=64):
        ...
        self.CIIM = nn.Sequential(FAP(64, num_groups=4, hidden_dim=32))
    ...
    def forward(self,x):
        ...
        r1 = F.interpolate(self.predtrans2(x1), size=416, mode='bilinear')
